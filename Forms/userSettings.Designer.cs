namespace IBMiCmd.Forms
{
    partial class userSettings
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "IBMiCmd uses remote builds, and a remote\r\nmachine is required to host the builds." +
    " Please \r\nenter the remote system details below.";
			// 
			// label2
			// 
			...
			this.label7.Text = "Libl (lib,lib,lib):";
			// 
			// textBox6
			// 
			this.textBox6.Location = new System.Drawing.Point(141, 304);
